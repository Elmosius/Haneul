...
onMounted(() => {
  if (!hero.value || !title.value || !test.value || !test2.value || !test3.value || !img.value || !img2.value || !img3.value) return;
...
<template>
  <section ref="hero" class="relative">
    <div class="text-gwhite flex flex-col gap-5 justify-center items-center h-screen bg-night">
  ...
  <div class="relative">
    ...
    <div class="absolute inset-0 bg-gwhite h-screen z-20" ref="test" />
  </div>
